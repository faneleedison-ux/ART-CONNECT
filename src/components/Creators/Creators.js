...
import Jared from  './img/jared.jpg';
import Erlich from './img/erlich.jpg';
...
const db = [
  ...
  {
    name: 'Richard Hendricks: Cartoonist',
    url : Richard,
    
  },
  {
    name: 'Erlich Bachman: VFX Level Designer' ,
    url: Erlich,
    
  },
  {
    name: 'Monica Hall : 3D Artist Developer',
    url: Monica,
    
  },
  {
    name: 'Jared Dunn: Illustrator',
    url:  Jared,
    
  },
  {
    name: 'Dinesh Chugtai: Game Developer ',
    url: Dinesh,
